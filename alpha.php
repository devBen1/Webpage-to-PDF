    ...
    <div class="container">
        <div class="row" id="clientsReport">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">VULNERABILITY (
                    <?php echo $character1['IP']; ?> )
                </div>
                <!-- Table LOOP-->
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th>PORTS</th>
                            <td>
                                <?php echo implode(",",$character1['PORTS']); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>PORTS NO</th>
                            <td>
                                <?php echo count($character1['PORTS']); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>VULN</th>
                            <td>
                                <?php echo implode(",",$character1['VULN']); ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <th>VULN NO</th>
                            <td>
                                <?php echo count($character1['VULN']); ?>
                            </td>
                        </tr>
                    </tbody>
                </table>
